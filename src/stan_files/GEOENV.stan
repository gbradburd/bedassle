functions {
	...
	matrix spCov(int N, real a0, real aD, real a2, matrix D, vector aE, matrix[] sqE, vector nugget, real gamma, int nE) {
		matrix[N,N] parCov;
		matrix[N,N] Nug_mat;
		matrix[N,N] Edist;
...
transformed parameters {
	...
	parCov = spCov(N, alpha0, alphaD, alpha2, geoDist, alphaE, sqE, nugget,  gamma, nE);
}
model {
